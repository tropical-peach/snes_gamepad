...
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports { snes_data }];
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports { snes_latch }];
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports { snes_clk }];
